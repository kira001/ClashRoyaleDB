...
void Card::setManaCost(unsigned int mana){
    manaCost=mana;
}
void Card::setCardRarity(Card::rarity rar){
    cardRarity=rar;
}
void Card::setCardLevel(unsigned int cLevel){
    cardLevel=cLevel;
}
...
Card::rarity Card::getCardRarity() const {
    return cardRarity;
}
unsigned int Card::getCardLevel() const {
    return cardLevel;
}
...
unsigned int Card::getMaxLevel() const{
    return MaxLevel;
}
